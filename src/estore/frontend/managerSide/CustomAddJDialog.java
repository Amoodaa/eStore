...
public abstract class CustomAddJDialog extends javax.swing.JDialog implements Filler {

    protected Entity entity;

    public CustomAddJDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    protected abstract boolean areValid(String[] arr);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomAddJDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
